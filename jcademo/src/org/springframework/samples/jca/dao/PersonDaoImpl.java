...
import org.springframework.samples.jca.standalone.PersonMappingOperation;
...
public class PersonDaoImpl extends CciDaoSupport implements PersonDao {
	...
	public Person getPersonVersion2(int id) throws PersonException{
		PersonMappingOperation pmo = new PersonMappingOperation(this.getConnectionFactory());
		//id是输入参数
		Person person = (Person)pmo.execute(new Integer(id));
		return person;
	}
