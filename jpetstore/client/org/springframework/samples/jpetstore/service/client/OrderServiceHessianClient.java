 ...
 * </pre>
 */
public class OrderServiceHessianClient {

	protected static final Log log = LogFactory.getLog(OrderServiceHessianClient.class);
	...
	public static void main(String[] args) {
			...
			OrderService os = (OrderService)beanFactory.getBean("hessianProxy");
