 ...
 * </pre>
 */
public class OrderServiceRmiClient {

	protected static final Log log = LogFactory.getLog(OrderServiceRmiClient.class);
	...
	public static void main(String[] args) {
			ListableBeanFactory beanFactory = new ClassPathXmlApplicationContext("rmiClientContext.xml");
			OrderService os = (OrderService)beanFactory.getBean("rmiProxy");
