 ...
 * </pre>
 */
public class OrderServiceJaxRpcClient {

	protected static final Log log = LogFactory.getLog(OrderServiceJaxRpcClient.class);
	...
	public static void main(String[] args) {
			ListableBeanFactory beanFactory = new ClassPathXmlApplicationContext("jaxrpcClientContext.xml");
			OrderService os = (OrderService)beanFactory.getBean("jaxRpcProxy");
